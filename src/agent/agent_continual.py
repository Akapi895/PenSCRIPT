...
project_root = os.path.dirname(os.path.dirname(curr_path))
sys.path.insert(0, project_root)

from src.agent.util import UTIL, color, Matrix, Merge_str_lst
from src.agent.policy.config import *
from src.agent.agent import Agent
import src.agent.continual as CL_Agents
