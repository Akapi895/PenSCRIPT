...
from src.envs.storyboard import Storyboard
...
def save_restore_firewall_rules_all_hosts (flag):
    ...
    scripts_dir = Path(__file__).parent / 'core' / 'scripts'
    script_path = scripts_dir / 'save_restore_firewall_rule.exp'
...
def add_firewall_rules_all_hosts (subnet_id):
    ...
    scripts_dir = Path(__file__).parent / 'core' / 'scripts'
    script_path = scripts_dir / 'add_firewall_rule.exp'
...
def open_firewall_rule_e_samba(host):
    ...
    """
    scripts_dir = Path(__file__).parent / 'core' / 'scripts'
    script_path = scripts_dir / 'open_firewall_rule.exp'
...
def update_default_gw (target_host, bridge_ip):
    ...
    scripts_dir = Path(__file__).parent / 'core' / 'scripts'
    script_path = scripts_dir / 'del_add_default_gw.exp'
